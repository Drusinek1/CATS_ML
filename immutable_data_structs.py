...
CLS_raw_engineering_struct = np.dtype([('LaserEnergyMonitors', np.int32, (3,)),
                                       ('TemperatureMeasurements', np.int32, (12,)),
                                       ('VoltageMeasurements', np.int32, (3,)),
                                       ('Pressure', np.int32),
...
CLS_decoded_header_struct = np.dtype([('RecordNumber', np.int32), ('ExactTime', DT.datetime), ('NumChannels', np.int8),
                                      ('Resolution', np.uint8), ('DetectorSequence', np.uint8, (9,)),
                                      ('NumberT_Probes', np.uint8), ('NumberV_Probes', np.uint8),
                                      ('Reserved', np.uint8, (20,))])
